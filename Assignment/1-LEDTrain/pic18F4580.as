...
TOSU equ 0FFFh ;# 
	...
	FNCALL	_main,_left_to_right
	FNCALL	_main,_right_to_left
	FNROOT	_main
	global	_cond
	global	_flag
	global	_num
...
__pcstackCOMRAM:
?_right_to_left:	; 1 bytes @ 0x0
??_right_to_left:	; 1 bytes @ 0x0
?_left_to_right:	; 1 bytes @ 0x0
??_left_to_right:	; 1 bytes @ 0x0
...
l698:
;main.c: 24: {
;main.c: 25: left_to_right();
	call	_left_to_right	;wreg free
	line	26
;main.c: 26: }
	goto	l702
	line	27
...
;main.c: 27: else
;main.c: 28: {
;main.c: 29: right_to_left();
	call	_right_to_left	;wreg free
	goto	l702
	line	30
...
psect	text1
	file	"right_to_left.c"
	line	4
	global	__size_of_right_to_left
	__size_of_right_to_left	equ	__end_of_right_to_left-_right_to_left
...
l666:
;right_to_left.c: 8: {
;right_to_left.c: 9: num = num | mask;
	movf	((c:_num)),c,w
	iorwf	((c:_mask)),c,w
	movwf	((c:_num)),c
	movf	((c:_num+1)),c,w
	movwf	1+((c:_num)),c
	line	10
;right_to_left.c: 10: mask = mask >> 1;
	bcf	status,0
	rrcf	((c:_mask)),c,w
	movwf	((c:_mask)),c
	line	11
...
l668:
;right_to_left.c: 11: PORTB = num;
	movff	(c:_num),(c:3969)	;volatile
	line	12
;right_to_left.c: 12: if(num == 255)
		incf	((c:_num)),c,w
iorwf	((c:_num+1)),c,w
	btfss	status,2
	goto	u21
...
l670:
;right_to_left.c: 13: {
;right_to_left.c: 14: cond = 0;
	movlw	high(0)
	movwf	((c:_cond+1)),c
	movlw	low(0)
	movwf	((c:_cond)),c
	line	15
;right_to_left.c: 15: mask = 128;
	movlw	low(080h)
	movwf	((c:_mask)),c
	goto	l17
	line	16
...
l672:
;right_to_left.c: 18: else
;right_to_left.c: 19: {
;right_to_left.c: 20: num = num >> 1;
	rlcf	((c:_num+1)),c,w
	rrcf	((c:_num+1)),c,w
	movwf	(??_right_to_left+0+0)&0ffh,c
	rrcf	((c:_num)),c,w
	movwf	((c:_num)),c
	movff	??_right_to_left+0+0,((c:_num+1))
	line	21
	
l674:
;right_to_left.c: 21: PORTB = num;
	movff	(c:_num),(c:3969)	;volatile
	line	22
;right_to_left.c: 22: mask = mask >> 1;
	bcf	status,0
	rrcf	((c:_mask)),c,w
	movwf	((c:_mask)),c
	line	23
;right_to_left.c: 23: if(num == 0)
	movf	((c:_num)),c,w
iorwf	((c:_num+1)),c,w
	btfss	status,2
	goto	u31
...
l676:
;right_to_left.c: 24: {
;right_to_left.c: 25: flag = 1;
	movlw	high(01h)
	movwf	((c:_flag+1)),c
	movlw	low(01h)
	movwf	((c:_flag)),c
	line	26
;right_to_left.c: 26: cond = 1;
	movlw	high(01h)
	movwf	((c:_cond+1)),c
	movlw	low(01h)
	movwf	((c:_cond)),c
	line	28
;right_to_left.c: 28: mask = 1;
	movlw	low(01h)
	movwf	((c:_mask)),c
	goto	l17
	line	29
...
l17:
	return	;funcret
	opt stack 0
GLOBAL	__end_of_right_to_left
	__end_of_right_to_left:
	signat	_right_to_left,89
	global	_left_to_right
...
psect	text2
	file	"left_to_right.c"
	line	4
	global	__size_of_left_to_right
	__size_of_left_to_right	equ	__end_of_left_to_right-_left_to_right
...
l680:
;left_to_right.c: 8: {
;left_to_right.c: 9: num = num | mask;
	movf	((c:_num)),c,w
	iorwf	((c:_mask)),c,w
	movwf	((c:_num)),c
	movf	((c:_num+1)),c,w
	movwf	1+((c:_num)),c
	line	10
;left_to_right.c: 10: mask = mask << 1;
	movf	((c:_mask)),c,w
	addwf	((c:_mask)),c,w
	movwf	((c:_mask)),c
	line	11
...
l682:
;left_to_right.c: 11: PORTB = num;
	movff	(c:_num),(c:3969)	;volatile
	line	12
;left_to_right.c: 12: if(num == 255)
		incf	((c:_num)),c,w
iorwf	((c:_num+1)),c,w
	btfss	status,2
	goto	u51
...
l684:
;left_to_right.c: 13: {
;left_to_right.c: 14: cond = 0;
	movlw	high(0)
	movwf	((c:_cond+1)),c
	movlw	low(0)
	movwf	((c:_cond)),c
	line	15
;left_to_right.c: 15: mask = 1;
	movlw	low(01h)
	movwf	((c:_mask)),c
	goto	l34
	line	16
...
l686:
;left_to_right.c: 18: else
;left_to_right.c: 19: {
;left_to_right.c: 20: num = num << 1;
	bcf	status,0
	rlcf	((c:_num)),c,w
	movwf	((c:_num)),c
	rlcf	((c:_num+1)),c,w
...
l688:
;left_to_right.c: 21: PORTB = num;
	movff	(c:_num),(c:3969)	;volatile
	line	22
;left_to_right.c: 22: mask = mask << 1;
	movf	((c:_mask)),c,w
	addwf	((c:_mask)),c,w
	movwf	((c:_mask)),c
	line	23
;left_to_right.c: 23: if(num == 0)
	movf	((c:_num)),c,w
iorwf	((c:_num+1)),c,w
	btfss	status,2
	goto	u61
...
l690:
;left_to_right.c: 24: {
;left_to_right.c: 25: flag = 0;
	movlw	high(0)
	movwf	((c:_flag+1)),c
	movlw	low(0)
	movwf	((c:_flag)),c
	line	26
;left_to_right.c: 26: cond = 1;
	movlw	high(01h)
	movwf	((c:_cond+1)),c
	movlw	low(01h)
	movwf	((c:_cond)),c
	line	27
;left_to_right.c: 27: num = 0;
	movlw	high(0)
	movwf	((c:_num+1)),c
	movlw	low(0)
	movwf	((c:_num)),c
	line	28
;left_to_right.c: 28: mask = 128;
	movlw	low(080h)
	movwf	((c:_mask)),c
	goto	l34
	line	29
...
l34:
	return	;funcret
	opt stack 0
GLOBAL	__end_of_left_to_right
	__end_of_left_to_right:
	signat	_left_to_right,89
	global	_init_config
